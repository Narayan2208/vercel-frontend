...
const Index: React.FC = () => {
  ...
  const featuredJobs = useSelector((state: RootState) => state.jobs.featuredJobs);
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <Link to="/jobs" className="text-primary hover:text-primary/90 transition-colors">
          ...
          >
            ...
            <p className="text-muted-foreground mb-4">
              Browse our directory of top employers and learn about their company culture and values.
            </p>
          ...
          >
            <div className="flex items-center space-x-4 mb-4">
              <div className="p-3 rounded-full bg-green-100">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-file-text"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>
              </div>
              <h3 className="text-lg font-semibold">Career Resources</h3>
            </div>
            <p className="text-muted-foreground mb-4">
              Access our library of career resources and get expert advice on resume writing, interviewing, and more.
            </p>
            <a href="#" className="text-primary hover:text-primary/90 transition-colors">
